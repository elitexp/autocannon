...
Client.prototype._connect = function () {
  if (this.secure) {
    ...
    if (this.ipc) {
      ...
      if (this.opts.proxyOptions?.host && this.opts.proxyOptions?.port) {
        this.conn = net.connect(this.opts.proxyOptions.port, this.opts.proxyOptions.host, () => {
          this.conn.write(`GET / HTTP/1.1\r\nHost: ${this.opts.hostname}\r\n\r\n`)
        })
      } else {
